class ParsedFunction implements Function
{
	...
	class LessThan extends Expression{
		...
		public LessThan(Expression l, Expression r){this.l = l; this.r = r;}
		public double evaluate(double x) {
	...
	class LessThanEqual extends Expression{
		protected Expression l,r;
		public LessThanEqual(Expression l, Expression r){this.l = l; this.r = r;}
		public double evaluate(double x) {
			return (l.evaluate(x) <= r.evaluate(x))?1:0;
	}};
	...
	class GreaterThan extends Expression{
		protected Expression l,r;
		public GreaterThan(Expression l, Expression r){this.l = l; this.r = r;}
		public double evaluate(double x) {
			return (l.evaluate(x) > r.evaluate(x))?1:0;
	}};
	...
	class GreaterThanEqual extends Expression{
		protected Expression l,r;
		public GreaterThanEqual(Expression l, Expression r){this.l = l; this.r = r;}
		public double evaluate(double x) {
			return (l.evaluate(x) >= r.evaluate(x))?1:0;
	}};
	...
	class Equal extends Expression{
		protected Expression l,r;
		public Equal(Expression l, Expression r){this.l = l; this.r = r;}
		public double evaluate(double x) {
			return (l.evaluate(x) == r.evaluate(x))?1:0;
	}};
	...
	class NotEqual extends Expression{
		protected Expression l,r;
		public NotEqual(Expression l, Expression r){this.l = l; this.r = r;}
		public double evaluate(double x) {
			return (l.evaluate(x) != r.evaluate(x))?1:0;
	}};
	...
	class Sine extends Fn{	public Sine(Expression e) {super(e);} public double evalFn(double val) {
		return Math.sin(val);	}	};

	class Cosine extends Fn{	public Cosine(Expression e) {super(e);} public double evalFn(double val) {
		return Math.cos(val);	}	};

	class Tan extends Fn{	public Tan(Expression e) {super(e);} public double evalFn(double val) {
		return Math.tan(val);	}	};

	class Exp extends Fn{	public Exp(Expression e) {super(e);} public double evalFn(double val) {
		return Math.exp(val);	}	};

	class Abs extends Fn{	public Abs(Expression e) {super(e);} public double evalFn(double val) {
		return Math.abs(val);	}	};
}