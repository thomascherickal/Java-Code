...
class Transmission implements Solvable
{
	...
	*/
	...
	protected static double getTransmission(ComplexMatrix m)	{	return m.a.reciprocal().modulusSquared();	}

	/**	Extracts the reflection coefficient from a matrix	*/
	protected static double getReflection(ComplexMatrix m)		{	return m.c.divide(m.a).modulusSquared();	}
