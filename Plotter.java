...
class Plotter
{
	...
	*/
	public boolean isInterpolated()			{	return interpolate;	}

	/**	Set to <code>true</code> if <i>y</i> values between samples should be
		interpolated, else <code>false</code>
	*/
	public void setInterpolated(boolean b)	{	interpolate = b;	}
	...
	*/
	...
	public boolean isLogarithmic()			{	return log;	}

	/**	Sets whether graph data should be log()'d before plotting	*/
	public void setLogarithmic(boolean b)	{	log = b;	}
