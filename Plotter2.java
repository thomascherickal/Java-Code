...
class Plotter2 extends Plotter
{
	...
	*/
	...
	public void setMinY(double d)		{	setRangeY(d,maxY);	}

	/**	Adjusts the maximum <i>y</i> value 	*/
	public void setMaxY(double d)		{	setRangeY(minY,d);	}

	/**	Adjusts the minimum <i>x</i> value 	*/
	public void setMinX(double d)		{	setRangeX(d,maxX);	}

	/**	Adjusts the maximum <i>x</i> value 	*/
	public void setMaxX(double d)		{	setRangeX(minX,d);	}


	/**	Converts an <i>x</i> value from graph space to screen space	*/
	public int toScreenX(double d)		{	return x+hSpace+super.toScreenX(d,w-hSpace);	}

	/**	Converts a <i>y</i> value from graph space to screen space	*/
	public int toScreenY(double d)		{	return y+super.toScreenY(d,h-vSpace);	}

	/**	Converts an <i>x</i> value from screen space to graph space	*/
	public double fromScreenX(int i)	{	return super.fromScreenX(i-hSpace-x,w-hSpace);	}

	/**	Converts a <i>y</i> value from screen space to graph space	*/
	public double fromScreenY(int i)	{	return super.fromScreenY(i-y,h-vSpace);	}



	/**	Returns the colour used when plotting the actual graph	*/
	public Color getGraphColor()		{	return graphCol;	}

	/**	Sets the colour to use when plotting the actual graph	*/
	public void setGraphColor(Color c)	{	graphCol = c;		}
