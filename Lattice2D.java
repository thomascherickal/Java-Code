...
class Lattice2D
{
	...
	*/
	public int toScreenX(double x, int w)	{	return (int)(w/2 + x*xscl);	}
	...
	*/
	public int toScreenY(double y, int h)	{	return (int)(h/2 + y*yscl);	}
	...
	/**	Converts an <i>x</i> coordinate from screen space to lattice space
		...
		@param	w	The width of the display
	*/
	public double fromScreenX(int x, int w)	{	return (x-w/2)/xscl;	}
	...
	/**	Converts a <i>y</i> coordinate from screen space to lattice space
		...
		@param	h	The height of the display
	*/
	public double fromScreenY(int y, int h)	{	return (y-h/2)/yscl;	}
