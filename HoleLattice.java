	...
	public synchronized void advanceHoles()
	{
		for(int i=0; i<holes.size(); i++)
		{
			...
			switch(pos)
			{
				...
				case RIGHT:		pos = (Math.random()<0.5)?TOP:BOTTOM;
								break;
	...
	*/
	...
	/**
		...
		@param	b	<code>true</code> if animation should be on, otherwise
					<code>false</code>
	*/
	public void setSmooth(boolean b)	{	smooth = b;	}
	...
	protected class Basis
	{
		...
		*/
		public Point getPosition(int pos)
		{
            switch(pos)
			{
				case TOP:		return new Point(holeW+insetX, 0);
				case LEFT:		return new Point(0, holeH+insetY);
				case BOTTOM:	return new Point(holeW+insetX, atomH+holeH);
				case RIGHT:		return new Point(atomW+holeW, holeH+insetY);
				default:		throw new RuntimeException("invalid position:  "+pos);
			}
		}
